...
const JourneySection = () => {
  ...
  return (
    <div ref={ref} className="py-2 ">
      <div className="">
        {/* Section Heading */}
        <h1 className="text-3xl  px-3 md:px-0 md:text-4xl  font-bold text-black mb-6">
        ...
        <div className="flex justify-center md:items-center md:gap-10">
          ...
          <div className="p-6 text-center  w-60">
            ...
            <p className="text-[#21083B] text-lg md:text-xl mt-2">Onboard People</p>
          </div>
          ...
          <div className="p-6 text-center   w-60">
            ...
            <p className="text-[#21083B] text-lg  md:text-xl mt-2">Offices</p>
          </div>
          ...
          <div className="p-6 text-center w-60 ">
            ...
            <p className="text-[#21083B] text-lg md:text-xl mt-2">Projects Completed</p>
          </div>
        </div>
      </div>
    </div>
