...
const ServiceCard = ({
  ...
  return (
    <div
      ...
      className={`bg-white items-center  justify-center max-h-[50rem] shadow-md p-6 w-20 rounded-3xl relative overflow-hidden cursor-pointer ${
...
const ServicesWithAnimation = () => {
  const [visibleCards, setVisibleCards] = useState({
    about: true, // Default section visible
    services: false,
    rnd: false,
    industries: false,
  });
  const [currentSection, setCurrentSection] = useState(0); // Start at "about"
  ...
  const handleNavigation = (direction) => {
    setCurrentSection((prev) => {
      let newIndex;
      if (direction === "next") {
        newIndex = (prev + 1) % sections.length; // Loop to the start
      } else if (direction === "prev") {
        newIndex = (prev - 1 + sections.length) % sections.length; // Loop to the end
      } else {
        newIndex = prev;
      }
  
      const updatedVisibility = sections.reduce((acc, section, index) => {
        acc[section] = index <= newIndex; // Set true for current and all previous sections
        return acc;
      }, {});
  ...
  const servicesContent = {
    about: [
      ...
      },
      {
        ...
        heading: "Research",
        description:
          "Designing and building intuitive mobile and web applications to meet your business needs.",
      },
      {
        image: "/Images/services/about/marketing.png",
        heading: "Marketing",
        description:
          "Crafting intuitive and visually appealing interfaces to improve user satisfaction.",
      },
      {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Designing and building intuitive mobile and web applications that meet your business needs.",
      },
      {
    ...
    industries: [
      {
        ...
        heading: "Travel",
        description:
          "Enhancing travel experiences with innovative solutions for booking, itinerary management, and more.",
      },
      {
        image: "/Images/services/industries/healthcare.png",
        heading: "Healthcare",
        description:
          "Designing and building intuitive mobile and web applications that meet healthcare needs.",
      },
      {
        image: "/Images/services/industries/education.png",
        heading: "Education",
        description:
          "Crafting intuitive and visually appealing interfaces for the education sector.",
      },
      {
        image: "/Images/services/industries/retail.png",
        heading: "Retail",
        description:
          "Creating and managing targeted social media campaigns to build brand awareness in retail.",
      },
    ],
  };
